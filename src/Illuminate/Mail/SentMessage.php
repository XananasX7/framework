...
class SentMessage
{
    ...
    public function __unserialize(array $data)
    {
        ...
        $this->sentMessage = $hasAttachments ? unserialize(base64_decode($data['sentMessage']), ['allowed_classes' => [\Symfony\Component\Mime\Email::class, \Symfony\Component\Mailer\SentMessage::class]]) : $data['sentMessage'];
    }
}
